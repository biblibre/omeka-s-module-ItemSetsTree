...
namespace DoctrineProxies\__CG__\ItemSetsTree\Entity;

/**
 * DO NOT EDIT THIS FILE - IT WAS CREATED BY DOCTRINE'S PROXY GENERATOR
 */
class ItemSetsTreeEdge extends \ItemSetsTree\Entity\ItemSetsTreeEdge implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (ItemSetsTreeEdge $proxy) {
    ...
    public function setParentItemSet(\Omeka\Entity\ItemSet $itemSet)
    {
        ...
        return parent::setParentItemSet($itemSet);
    }
